        ...
        $(document).ready(function() {
            ...
            $(".selfie-like").click(function(e){
                ...
                $.ajax({
                    ...
                    type: "POST",
                    data: {id : id, token : token, UserCode : UserCode},
                    dataType: "json",
            ...
            <div class="vc-wrapper">
               ...
               <div class="vc-like">
                    <ul>
                        ...
                        <li>
                            <img class = "selfie-like" data-UserCode = "'.$_SESSION["UserCode"].'" data-item = "' . $userSelfie["Id"] . '" data-token = "' . $_SESSION['token'] . '" src="' . $Application["BaseURL"] . '/theme/' . $_REQUEST["Theme"] . '/image/valentine_contest/like.jpg" >
                        </li>
                    </ul>
                </div>
            </div>

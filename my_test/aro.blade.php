...
<body>
    <form id="frmMoreTopGames" runat="server">
        ...
        <table cellpadding="0" cellspacing="0" class="TABLE">
            <tr>
                <td align="left" valign="top">
                    ...
                    <table id="dataListRelatedvideo" cellspacing="0" border="0" style="width: 100%; border-collapse: collapse;">
                        ...
                        <tr>
                            <td>
                                <div class="preview" style="width: 98%">

                                   <div style="width: 49%;border: 4px #fff solid;">
                                        <a id="" class="imgResizeTest" href="" oncontextmenu="return false">
                                    ...
                                    <div style="width: 49%;border: 4px #fff solid;">
                                        <a id="" class="imgResizeTest" href="" oncontextmenu="return false">
                                            <img src="../Images/Ui_img/Pro_Tennis_2014.jpg" style="width: 100%;">
                                        </a>
                                        <span class="slide-title"></span>
                                    </div>
                        ...
                        <tr>
                            <td>
                                <button type="button" class="btn footer_btn" >More..</button>
                            </td>                            
                        </tr>
                    </table>
                </td>
            ...
            <tr>
                <td align="left" valign="top">
                    <uc6:Footer ID="FooterControl" runat="server" />
                </td>
            </tr>
        </table>
    </form>
